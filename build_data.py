...
tf.flags.DEFINE_string('X_input_dir', 'data/licensePlate/trainA',
                       'X input directory, default: data/licensePlate/trainA')
tf.flags.DEFINE_string('Y_input_dir', 'data/licensePlate/trainB',
                       'Y input directory, default: data/licensePlate/trainB')
